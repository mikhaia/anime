(function () {
    ...
    function updateFullscreenIcon(isActive) {
        ...
        fullscreenIcon.querySelectorAll('[data-fullscreen-icon-state="enter"]').forEach((element) => {
            element.classList.toggle('hidden', isActive);
        });

        fullscreenIcon.querySelectorAll('[data-fullscreen-icon-state="exit"]').forEach((element) => {
            element.classList.toggle('hidden', !isActive);
        });
    }
    ...
    function createFavoriteButton(payload) {
        ...
        icon.classList.add('anime-card__favorite-icon');
