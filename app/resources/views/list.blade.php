...
@section('content')
    ...
    <section class="page-content @if(in_array($mode, ['top', 'new'])) page-content--wide @endif">
        ...
        @else
            <p>Здесь будет отображён список аниме с фильтрами, сортировками и удобной навигацией. Для каждого режима можно
                вывести отдельные подборки и карточки тайтлов.</p>
        @endif
    </section>
@endsection
